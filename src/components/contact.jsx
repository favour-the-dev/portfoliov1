            ...
            <footer className="w-screen lg:px-20 py-5 px-2 sm:px-5 lg:py-5 text-text flex flex-col items-center justify-center" id="Contact">
                <div className="flex flex-col items-center justify-center w-full space-y-6 my-12">
                    ...
                    <div className="flex items-center w-3/4 md:w-full justify-center text-xs sm:text-xm md:text-base space-x-2 md:space-x-4">
                        <a href='http://malito:favourto91@gmail.com' target='blank_' className="bg-gray-500 bg-opacity-50 p-2 hover:bg-opacity-30 flex items-center md:gap-2"><AiFillMail/>favourto91@gmail.com</a>
                        ...
                        <a href='https://www.linkedin.com/feed/' target='blank_' className="bg-gray-500 bg-opacity-50 p-2 hover:bg-opacity-30 flex items-center md:gap-2"><AiFillLinkedin/>Linkedin</a>
                    </div>
                    <div className="flex items-center justify-center w-3/4 md:w-full text-xs sm:text-xm md:text-base space-x-2 md:space-x-4">
                        <a href='https://twitter.com/home?lang=en' target='blank_' className="bg-gray-500 bg-opacity-50 p-2 hover:bg-opacity-30 flex items-center md:gap-2"><AiOutlineTwitter/>Twitter</a>
                        <a href='https://www.instagram.com/' target='blank_' className="bg-gray-500 bg-opacity-50 p-2 hover:bg-opacity-30 flex items-center md:gap-2"><AiOutlineInstagram/>Instagram</a>
                        <a href='https://github.com/' target='blank_' className="bg-gray-500 bg-opacity-50 p-2 hover:bg-opacity-30 flex items-center md:gap-2"><AiFillGithub/>Github</a>
                    </div>
                </div>
