                ...
                <div className='flex flex-col gap-2 lg:gap-0 md:flex-row lg:items-center'>
                    <div className='flex flex-col gap-4 lg:w-1/2 order-2 lg:order-1'>
                        ...
                        <div className='flex items-center space-x-4'>
                            <a href="http://malito:favourto91@gmail.com" className='bg-text rounded-full text-main px-2 py-1 lg:px-4 lg:py-2 hover:bg-gray-300 duration-200 ease-linear'>Send an Email</a>
                            <a href="#Contact" className='border-2 border-text px-2 py-1 lg:px-4 lg:py-2 rounded-full hover:bg-text hover:text-main duration-200 ease-linear'>Contact me</a>
                        </div>
                    </div>
                    <div className='flex mx-auto md:w-1/2 mb-4 lg:mb-0 justify-center lg:order-2'>
